...
![exporteren](images/export-2.png)
...
2. Scrol naar Export
3. Klik op Doelmap kiezen en selecteer de map waar je je export wil bewaren

![exportfolder configureren](images/export-config.png)
